...
public class PlayListTest {
    ...
    public static void main(String[] arg) {
        ...
        //ADD MORE CODE HERE...
        PlayList track = new PlayList("My Track");
        
        //adding songs to my playlist
        track.addSong( new Song( "Best thing I ever had", 300, "Beyonce") );
        track.addSong( new Song( "Paradise", 280, "Coldplay") );
        track.addSong( new Song( "Stay", 270, "Rihanna") );
        
        //Outputting the details of the song
        
        System.out.println(track.toString() + "\n");
        
        System.out.println("Number of Songs: " + track.numberOfSongs());
        System.out.println("Total time: " + track.getTotalTime() + " seconds\n");

        System.out.println("Playing each song...");
        for (int i = 0; i < track.numberOfSongs(); i++) {
            track.getSong(i).play();
        }
