...
public class BankAccountTest {
    ...
    public static void main(String[] args) {
        ...
        IsaAccount isacc = new IsaAccount(5000);
        System.out.println("\n" + isacc.toString());
        isacc.deposit(2000);
        System.out.println("This is the deposit remaining: " + isacc.getDepositRemaining());
        isacc.resetDepositRemaining();
        System.out.println("Reset the deposit: " + isacc.toString());
